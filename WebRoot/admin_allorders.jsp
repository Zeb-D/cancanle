        ...
        <div class="result-wrap">
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    ...
                    <a id="updateOrd" href="javascript:void(0)"><i class="icon-font"></i>显示所有订单</a>
                    ...
                    <table class="result-tab" width="100%">
                        ...
                        <c:forEach items="${page.list}" var="all">
							...
							<c:choose>
								...
								<c:when test="${all.state=='确认订单'}">
								 	<td>
									 <a>正在派送</a>
									</td>
								</c:when>
								<c:when test="${all.state=='完成订单'}">
									<td>
									 <a>订单完成</a>
									</td>
								</c:when>
								<c:when test="${all.state=='取消订单'}">
									<td>
									 <a>订单取消</a>
									</td>
								</c:when>
