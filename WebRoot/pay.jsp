...
<div style="padding:0px">
<link href="css/ordersearchform1.css" rel="stylesheet" type="text/css" />
<script language="javascript" src="js/ordersearch.js"></script>

<div class="ordersearchform">
<form id="ordersearch" method="get" action="">
  <div class="searchform1">
    确认送餐地址：</br><input name="os_orderno" type="radio" class="input" id="os_orderno" value="" size="20" maxlength="8" /></br>
    <input name="os_orderno" type="radio" class="input" id="os_orderno" value="" size="20" maxlength="8" /> </br>
    <input name="os_orderno" type="radio" class="input" id="os_orderno" value="" size="20" maxlength="8" /> 
  </div>
  <div class="searchform">
    订单号：<input name="os_orderno" type="text" class="input" id="os_orderno" value="" size="20" maxlength="8" /> &nbsp; 
  </div>
   <div class="searchform2">
      价&nbsp;&nbsp;&nbsp;格：<input name="os_sname" type="text" class="input" id="os_sname" value="" size="20" maxlength="16" /> 
  </div>
  
  <div class="searchform2">
   订餐人：<input name="os_sname" type="text" class="input" id="os_sname" value="" size="20" maxlength="16" /> 
  </div>
  
   
  <div class="searchform3">
    <input type="submit" name="" value="确认付款" calss="bit"/>
</div>
</form>
</div>
